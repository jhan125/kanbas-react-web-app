  ...
  return (
    <div id="wd-bs-lists">
      <div id="wd-css-styling-lists">
        ...
        {/*  .list-group and .list-group-item classes can be applied to ul and li tags to make list stand out. 
             .active class can be applied to an li tag to highlight it. */}
      ...
      <div id="wd-css-hyperlink-list">
        ...
        {/*  .list-group and .list-group-item can be applied to div and a tags to implement a list of anchor links. */}
